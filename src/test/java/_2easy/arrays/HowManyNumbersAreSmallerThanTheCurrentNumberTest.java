...
import static com._1easy.hashtables.HowManyNumbersAreSmallerThanTheCurrentNumber.smallerNumbersThanCurrent3;
import static com._1easy.hashtables.HowManyNumbersAreSmallerThanTheCurrentNumber.smallerNumbersThanCurrent4;
...
public class HowManyNumbersAreSmallerThanTheCurrentNumberTest {
    ...
    void plusOneTest(int[] input, int[] expected) {
        int[] actual = smallerNumbersThanCurrent4(input);
